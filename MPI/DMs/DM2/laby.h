...
/* Description des types de cases.
   ...
   Ainsi entre deux cases a et b de coordonnées (i,j) et (i,j+1), ie l'une à
   côté de l'autre avec a à gauche, il y a un mur ssi la case a est de type 1
   ou 3, soit de type impair. Entre deux cases a et b de coordonnées (i,j) et
   (i+1,j), ie l'une au dessus de l'autre avec a au dessus, il y a un mur ssi
   la case a est de type 2 ou 3, soit de type de quotient modulo 2 égal à 1.
*/
