...
\begin{enumerate}
    \item $\varphi_1$\nbsp: Chaque caractéristique («\nbsp anglais\nbsp», «\nbsp poisson
        rouge\nbsp», …) se retrouve dans exactement une des cinq maisons
    \item $\varphi_2$\nbsp: Chaque maison doit avoir exactement une caractéristique de chaque
        catégorie (nationalité, boisson, couleur, …). Par exemple, la maison
        1 doit avoir exactement une couleur.
    \item $\varphi_3$\nbsp: Contraintes de l’énoncé
\end{enumerate}
...
\begin{itemize}
    \item \verb|1_anglais| représente «\nbsp l’anglais habite dans la maison
        1\nbsp»
    \item \verb|5_poisson_rouge| représente «\nbsp la personne habitant la
        maison 5 a pour animal de compagnie un poisson rouge\nbsp»
    \item \verb|3_yop| représente «\nbsp la personne habitant la maison 3
        boit du yop\nbsp»
    \item etc.
\end{itemize}
...
Pour modéliser la contrainte «\nbsp Chaque caractéristique se retrouve dans
exactement une des cinq maisons\nbsp», on peut d’abord modéliser la contrainte
«\nbsp La caractéristique $c$ se retrouve dans exactement une maison\nbsp»,
...
(i.e. «\nbsp Soit cette caractéristique est dans la maison 1 et aucune autre,
